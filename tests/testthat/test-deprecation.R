...
test_that("gradient scales use no deprecated ggplot2 idioms", {
  withr::local_options(lifecycle_verbosity = "error")
  expect_no_error(scale_color_gradient_hda(), class = "lifecycle_error_deprecated")
  expect_no_error(scale_color_gradient_pha(), class = "lifecycle_error_deprecated")
  expect_no_error(scale_fill_gradient_pha(), class = "lifecycle_error_deprecated")
})
