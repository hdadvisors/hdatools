...
- base_size:
  ...
  The base size of text elements; defaults to 13

- base_family:

  The base font family; defaults to "Montserrat"
...
The theme alone carries VHA's brand identity into an otherwise unbranded
plot: bar/column fills, point colors, and line colors default to
`vha_colors["Dark Turq"]` (via
...
VHA palette, and a continuous mapping uses the VHA sequential ramp (see
