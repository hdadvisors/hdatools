...
| 2 — Features | **0.4.0** | `release-0.4.0` | Tier 2 (§2.1–2.7): exported color vectors + accessor, designed continuous ramps + deprecations, ggplot2 4.x theme-carried palettes (floor → ≥ 4.0), VHA brand + "adding a brand" howto, CVD audit (document-only), span helper, focus palette | [archive/phase-2-features-0.4.0.md](archive/phase-2-features-0.4.0.md) | **done** — merged (PR #19, squash) |
