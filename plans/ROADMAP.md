...
| 3 — Fonts | **0.5.0** | `release-0.5.0` | Tier 3.1: systemfonts/ragg migration, drop showtext/sysfonts, consumer `dev: ragg_png` guidance (§4), side-by-side render comparison in one consumer before tagging | [archive/phase-3-fonts-0.5.0.md](archive/phase-3-fonts-0.5.0.md) | **done** — merged (PR #22), tagged v0.5.0 |
