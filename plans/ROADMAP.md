...
| 1 — Consolidation | **0.3.0** | `release-0.3.0` | Tier 1 (§1.1–1.4, 1.6): safety-net tests, brand registry, one scale factory, one theme builder, colour aliases. Output provably identical. | [phase-1-consolidation-0.3.0.md](phase-1-consolidation-0.3.0.md) | ready (gate: Q1, Q3) |
| 2 — Features | **0.4.0** | `release-0.4.0` | Tier 2 (§2.1–2.7): exported color vectors + accessor, designed continuous ramps + deprecations, ggplot2 4.x theme-carried palettes (floor → ≥ 4.0), VHA brand + "adding a brand" howto, CVD audit (document-only), span helper, focus palette | written at phase gate | blocked by Phase 1 (gate: Q2, Q4, Q6–Q9) |
